...
extlinks = {
    "yadism": ("https://yadism.readthedocs.io/%s", "yadism%s"),
    "banana": ("https://banana-hep.readthedocs.io/%s", "banana%s"),
    "pineappl": ("https://docs.rs/pineappl/latest/pineappl/%s", "pineappl%s"),
